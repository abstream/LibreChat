...
/**
 * Component for displaying the AI Tools Studio page
 * @returns AI Tools Studio React component
 */
export default function LandingAgents() {
  ...
  return (
    ...
    >
      ...
      <div className="header">AI agetns</div>

      <div className="container">
        {studios.map((studio) => (
          <div key={studio.id} className={`studio-card ${studio.className}`}>

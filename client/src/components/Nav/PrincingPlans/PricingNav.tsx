...
const PricingNav: FC<PricingNavProps> = ({ isSmallScreen }: PricingNavProps) => {
  ...
  return (
    <>
      <div
        className={cn(
          'group relative mt-1 flex h-10 cursor-pointer items-center gap-3 rounded-lg border-border-medium px-3 py-2 text-white transition-colors duration-200 bg-[#2f7ff7]',
